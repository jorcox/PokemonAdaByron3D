...
public class LoadModelTest<P extends ModelLoader.ModelParameters> extends Game {
    ...
    private void doneLoading() {
        ...
        //pok1.transform.setToTranslation(0, 0, 35);
        //pok1.transform.setToRotation(Vector3.X, 70).trn(0, 0, 6f);
        tr = tr.mul(rt);
        tr = tr.mul(rt2);
        pok1.transform = tr;
        ...
        Model pok2Model = assets.get("res/Models/Blastoise/Blastoise.obj", Model.class);
